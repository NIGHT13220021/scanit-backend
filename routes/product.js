...
// ── Import whichever name your auth middleware exports ──
// This tries authenticateAdmin first, falls back to authenticate
const authMiddleware = require('../middleware/auth');
const authenticate = authMiddleware.authenticateAdmin || authMiddleware.authenticate;
  ...
  try {
    ...
    const result = await db.query(
      `SELECT 
          ...
          sp.stock_quantity, sp.max_stock
       FROM products p
